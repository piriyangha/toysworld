	...
	<table align="left" border="1" style="border-collapse: collapse">
		...
		<c:forEach items="${product}" var="pro">
			<tr>
				...
				<td align="center"><a
					href=<c:url value="/all/product/editform/${pro.pid}"/>>Update</a> <a
					href=<c:url value="/all/product/viewProduct/${pro.pid}"/>>view</a><a
					href=<c:url value="/deleteProduct/${pro.pid}"/>>Delete</a></td>
			</tr>
		</c:forEach>
	</table>
</body>
